...
ImageFramebuffer::ImageFramebuffer(GLint width, GLint height, GLint scr_width, GLint scr_height) : width(width), height(height), scr_width(scr_width), scr_height(scr_height), shader("shaders/screen_shader.vert", "shaders/screen_shader.frag") {
